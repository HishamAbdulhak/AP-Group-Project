...
public class HomeController extends BaseController {
    ...
    public HomeController() {
        ...
        this.alertService = new AlertService(); // Initializing your custom AlertService
    }
    ...
    private void viewDocumentDirectly(String fileName, Node sourceNode) {
        ...
        if (file.exists()) {
            ...
            // Using your custom AlertService for Error Handling [cite: 32, 251]
    ...
    private void downloadToSystem(String fileName) {
        // Using your custom AlertService for Confirmation [cite: 33]
        ...
        if (confirm) {
            try {
                ...
                // Using your custom AlertService for Success Feedback [cite: 33, 252]
